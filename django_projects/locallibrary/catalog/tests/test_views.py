...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        test_user1 = User.objects.create_user(username='testuser1', password='profesordb')
        test_user2 = User.objects.create_user(username='testuser2', password='alumnodb')
        ...
        test_user2.user_permissions.add(permission)
        test_user2.save()
        test_author = Author.objects.create(first_name='Javier', last_name='Gonzalez')
